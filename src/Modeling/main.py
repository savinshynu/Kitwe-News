...
from transformers import AdamW, BertModel, BertTokenizer, get_scheduler

from dataset import NewsDataset
from model import BertClassifier


def main(df_filepath, model_savepath,  model_name="bert-base-uncased"):
    ...
    df.to_csv(model_savepath+"hist_bert_base-all_tuning.csv")

    #save pytorch model
    torch.save(model.state_dict(), model_savepath+'bert_base-all_tuning.pth')
